...
override_ssid="entry { placeholder: \"Enter SSID\"; } listview { lines: 0; padding: 40px 12px; }"                     
override_password="entry { placeholder: \"Enter password\"; } listview { lines: 0; padding: 40px 12px; }"             
override_disabled="mainbox { children: [ textbox-custom, listview ]; } listview { lines: 1; padding: 12px 12px 16px; }" 
# Prompt for password
get_password() {
